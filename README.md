...
> I am a fan of Generative Adversarial Networks (GANs). I like Ian Goodfellow.
...
这部分提供一个试玩的假图片生成Demo，你可以随心所欲的使用它们，它们由StyleGAN生成的假图片，没有任何版权问题。注意：每次刷新网页都会生成新的假图像，注意保存！
